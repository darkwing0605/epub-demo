<template>
	<div class="menu-bar">
		<transition name="slide-up">
			<div class="menu-wrapper" v-show="ifTitleShow" :class="{'hide-box-shadow': ifSettingShow || !ifTitleShow}">
				...
				<div class="setting-progress" v-else-if="showTag === 2">
					<div class="progress-wrapper">
						<input
							...
							:value="changeProgress !== 0 ? changeProgress : progress"
...
<script>
	...
	export default {
		...
		watch: {
			changeProgress: {
				deep: true,
				handler: function(newProgress, oldProgress) {
